...
?>
    <!-- form start -->
    <form action="<?php echo e(route('answer.store')); ?>" method="post" enctype= "multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeGym\Hackathon_QT_2021\resources\views/admin/answer/create.blade.php ENDPATH**/ ?>